...
function circleDisplays()
  if options['displayhealthcircle'] then
    setOption('displayhealthcircle', false)
	modules.game_healthcircle.setHealthCircle(false)
  else
    if not options['displayhealthcircle'] then
      setOption('displayhealthcircle', true)
...
function setOption(key, value, force)
  ...
  elseif key == 'displayhealthcircle' then
